/* ═══════════════════════════════════════════
   I18N.JS — Language Selection & Translation
   ═══════════════════════════════════════════ */
...
const dictionary = {
  ...
  "Get started with Kamgar Connect today.": {
    "en": "Get started with Kamgar Connect today.",
    "hi": "आज ही कामगार कनेक्ट से शुरू करें।",
    "mr": "आजच कामगार कनेक्ट सुरू करा."
  },
  "Hire Workers": {
    "en": "Hire Workers",
    "hi": "मज़दूर भर्ती करें",
    "mr": "कामगार भाड्याने घ्या"
  },
  "Find Work": {
    "en": "Find Work",
    "hi": "काम खोजें",
...
function applyTranslations(lang) {
  ...
  // Walk entire DOM for text node matches
...
function initLanguageGate() {
  ...
  gate.innerHTML = `
    <div class="lang-gate-content">
      ...
      <p class="lang-gate-subtitle">Choose your preferred language to continue</p>
...
window.selectLang = function(lang) {
  ...
  if (gate && typeof window.gsap !== 'undefined') {
    // GSAP wipe animation on selection
    window.gsap.to(gate, {
      opacity: 0,
      y: -60,
      scale: 0.96,
      ...
      onComplete: () => {
        gate.remove();
        // Initialize voice panel with selected language
